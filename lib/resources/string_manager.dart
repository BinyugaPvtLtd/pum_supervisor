class AppString {
  ...
  static const String passwordlength =
      "Password length should be more then 6 character";
  static const String errormsg = "Error Message";
  static const String error = "Error Occurred!";

  ///Forgot password screen
  // static const String Femail = "Email";
  static const String forgotpasshead = "Forgot \nPassword ?";
  static const String forgotsubtitle1 = "Please enter your email and tap ";
  static const String forgotsubtitle11 = "Please enter your email and tap on ";
  static const String request = "Request.";
  static const String forgotsubtitle2 = "Request To Change\nPassword";
  ...
  static const String linkrest = "Please check you inbox for a reset link";
